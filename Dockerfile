...
COPY rootfs/shared/root/docker/install/base.sh /docker/install/base.sh
...
COPY rootfs/shared/root/docker/install/php-extensions.sh /docker/install/php-extensions.sh
